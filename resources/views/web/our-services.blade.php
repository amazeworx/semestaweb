<x-web-layout>
  ...
  <section class="services-hero">
    ...
    <div class="relative flex w-full max-w-screen-xl justify-center mx-auto z-10 px-4 py-12 xl:px-12 xl:pt-40 xl:pb-12">
      <div class="w-full max-w-prose text-white text-center">
        <h1 class="font-display text-3xl font-bold xl:text-5xl xl:mb-4">Our Services</h1>
      </div>
    </div>
  </section>
