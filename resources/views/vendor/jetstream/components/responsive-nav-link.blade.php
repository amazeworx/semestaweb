...
? 'block pl-3 pr-4 py-2 border-l-4 border-blue-400 text-base font-medium text-blue-500 bg-blue-50 focus:outline-none
focus:text-blue-500 focus:bg-blue-100 focus:border-blue-500 transition'
