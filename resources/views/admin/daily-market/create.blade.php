<x-app-layout>
  ...
  <div class="py-12">
    <div class="max-w-7xl mx-auto mb-8 sm:px-6 lg:px-8">
      @if ($errors->any())
      <div x-data="{ show: true }" x-show="show" class="text-white px-6 py-4 border-0 rounded relative mb-4 bg-red-700">
        ...
        <div class="flex gap-6 justify-center">
          ...
          <div class="w-full max-w-xs">
            <div class="w-full p-8 rounded bg-white shadow">
              ...
              <div class="w-full">
                <button type="submit" name="draft" class="button button-outline shadow hover:shadow-md">Save
                  Draft</button>
                <button type="submit" name="publish" class="button button-contained button-orange">Publish</button>
              </div>
            </div>
          </div>
        </div>
        ...
        function app() {
          return {
            ...
            initDate() {
              ...
              this.$refs.date.value = today.getFullYear() +"-"+ ('0'+ todayMonth).slice(-2) +"-"+ ('0' + today.getDate()).slice(-2);
            },
            isSelectedDate(date) {
            ...
            getDateValue(date) {
              ...
              //this.datepickerValue = selectedDate.getFullYear() + "-" + selectedDate.getMonth() + "-" + selectedDate.getDate();
              this.$refs.date.value = selectedDate.getFullYear() +"-"+ ('0'+ selectedMonth).slice(-2) +"-"+ ('0' + selectedDate.getDate()).slice(-2);
